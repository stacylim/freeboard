...
export const Profile = styled.img`
  ...
  border: none;
`;
export const Box1InnerWrapper = styled.div`
  width: 1150px;
  display: flex;
  justify-content: space-between;
`;
export const InnerCenterWrapper = styled.div`
  width: 800px;
`;
...
export const Star = styled.img`
  ...
  height: 20px;
`;
export const Box1Content = styled.div`
  width: 1200px;
  border: none;
  padding-top: 10px;
  padding-left: 15px;
...
export const EditReplyRegister = styled.div`
  width: 91px;
  height: 52px;
  border: 1px, solid black;
